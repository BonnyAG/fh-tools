...
<div id="results" class="mt-4 p-4 border border-gray-300 rounded-md shadow-sm">
    <div class="flex flex-col md:flex-row md:items-end gap-3">
        ...
        <div class="w-[100%] mb-1 md:mb-0 md:w-[35%]">
            ...
            <div class="mt-1">
            <input type="text" bind:value={fatherName} name="name" id="name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" placeholder="John Doe" aria-describedby="name-description">
            </div>
        </div>
        <!-- Wife Name -->
        <div class="w-[100%] mb-1 md:mb-0 md:w-[35%]">
            ...
            <div class="mt-1">
            <input type="text" bind:value={motherName} name="name" id="name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" placeholder="John Doe" aria-describedby="name-description">
            </div>
        </div>
        <!-- FamilySearch ID -->
