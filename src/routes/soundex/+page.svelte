<svelte:head>
    <title>Soundex Converter - F.H Tools</title>
</svelte:head>
...
<script lang="ts">
    ...
    let surname: string = $state("Smith");
    let code: string = $state(soundex(surname));
</script>
                ...
                <div class="py-1">
                    <CitationContainer>
                        <Grid>
                            <Row class="mb-2">
                                <Column>
                                    <TextInput labelText="Surname" placeholder="Doe" bind:value={surname} on:change={() => {code = soundex(surname)} } />
                                </Column>
                            </Row>
                            <Row>
                                <Column>
                                    <CitationResult citation={code} />
                                </Column>
                            </Row>
                        </Grid>
                    </CitationContainer>
